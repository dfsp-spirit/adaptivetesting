#
# Demonstration script to simulate adaptive testing using catR in R, with
# the same settings and item pool as in the provided Python code for 'adaptivetesting'.
# This script performs simulations for multiple participants, estimates their ability levels,
# and prints summary statistics for comparison with the Python implementation.
#
# To run, first ensure you have R with the 'catR' and 'readr' packages installed (e.g., via `install.packages("catR")` in an R session).
# Then, source this script from your R session or, alternatively, on the system command line, execute:
#
#   Rscript catR_simulation.R
#
# Written by Tim Schaefer, 2025-11-03
